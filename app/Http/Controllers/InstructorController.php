...
class InstructorController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $course->save();
        return redirect()->route('instructor.index')->with('success', 'Vos modification ont été apportées avec succès !');
    }
    ...
    public function publish($id)
    {
        ...
        return redirect()->back()->with('danger', 'Votre cours doit avoir un tarif de défini, ainsi qu\'au moins une section vidéo de publiable !');
    }
