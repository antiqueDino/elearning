                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tabs-1" role="tabpanel">
                            ...
                            <div class="text-center mb-5">
                                <a class="primary-btn" href=" {{ route('instructor.currriculum.create', $course->id ) }} ">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 px3 py-3">
                                                <video width="300" height="180" controls>
                                                    <source src=" {{ asset("storage/courses_sections/$course->user_id/$section->video") }} " type="">
                                                </video>
                            ...
                            @else
                                <div class="text-center">
                                    <a href="{{ route('instructor.currriculum.create', $course->id) }}" class="primary-btn">
