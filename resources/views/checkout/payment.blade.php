...
<div class="container">
    <div class="row">
        <div class="col-lg-8">
            <form class="jumbotron row contact_form" action=" {{ route('checkout.charge') }} " id="payment-form" method="POST">
                @csrf
...
@section('stripe')
    ...
    <script>
        ...
        var stripe = Stripe('pk_test_51I1FbzIBT4otivP5WAIzJBjemkJE303kEMWe6k8aioZSog2KL7DCaOsrjNUGfnMojj4HoRIJfjzyyWBxffJ50bRD00xuty1ldg');
