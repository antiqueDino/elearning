    ...
    <div class="jumbotron">
                            ...
                            @foreach (\Cart::session(Auth::user()->id)->getContent() as $course)
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                        ...
                                        <small><a class="btn border" href=" {{ route('card.toWishList', $course->id) }} ">Ajouter à la liste de souhaits</a></small>
                                    </td>
        ...
        @else
            <div class="empty-cart text-center">
                ...
                <h4 class="my-5"> Votre panier est vide. Continuez vos achats et trouvez votre cours !</h4>
    ...
    <div class="wish-list jumbotron pt-3">
        ...
        @else
            <div class="empty-cart text-center">
                ...
                <h4 class="my-5"> Votre liste de souhaits est vide. Continuez vos achats et trouvez votre cours !</h4>
                <a href=" {{ route('courses.index') }} " class="primary-btn">
                    Continuez vos achats
